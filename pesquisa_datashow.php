...
include('conexao.php');
	...
	if($pesquisa == "data")
	{
		$result_reservas = "SELECT * FROM datashow_reserva WHERE data LIKE '%$pesquisar%'";
	} 
	elseif($pesquisa == "hora")
	{
		$result_reservas = "SELECT * FROM datashow_reserva WHERE hora LIKE '%$pesquisar%'";
	} 
	elseif($pesquisa == "nome")
	{
		$result_reservas = "SELECT * FROM datashow_reserva WHERE nome LIKE '%$pesquisar%'";
	} 
	elseif($pesquisa == "setor")
	{
		$result_reservas = "SELECT * FROM datashow_reserva WHERE setor LIKE '%$pesquisar%'";
	}
	else {
		$result_reservas = "SELECT * FROM datashow_reserva WHERE ramal LIKE '%$pesquisar%'";
	}
