...
include('conexao.php');
	...
	if($pesquisa == "data")
	{
		$result_reservas = "SELECT * FROM dvd WHERE data LIKE '%$pesquisar%'";
	} 
	elseif($pesquisa == "hora")
	{
		$result_reservas = "SELECT * FROM dvd WHERE hora LIKE '%$pesquisar%'";
	} 
	elseif($pesquisa == "nome")
	{
		$result_reservas = "SELECT * FROM dvd WHERE nome LIKE '%$pesquisar%'";
	} 
	elseif($pesquisa == "setor")
	{
		$result_reservas = "SELECT * FROM dvd WHERE setor LIKE '%$pesquisar%'";
	}
	else {
		$result_reservas = "SELECT * FROM dvd WHERE ramal LIKE '%$pesquisar%'";
	}
