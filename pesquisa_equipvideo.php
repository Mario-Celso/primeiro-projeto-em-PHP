...
include('conexao.php');
	...
	if($pesquisa == "data")
	{
		$result_reservas = "SELECT * FROM equipamento_video WHERE data LIKE '%$pesquisar%'";
	} 
	elseif($pesquisa == "hora")
	{
		$result_reservas = "SELECT * FROM equipamento_video WHERE hora LIKE '%$pesquisar%'";
	} 
	elseif($pesquisa == "nome")
	{
		$result_reservas = "SELECT * FROM equipamento_video WHERE nome LIKE '%$pesquisar%'";
	} 
	elseif($pesquisa == "setor")
	{
		$result_reservas = "SELECT * FROM equipamento_video WHERE setor LIKE '%$pesquisar%'";
	}
	else {
		$result_reservas = "SELECT * FROM equipamento_video WHERE ramal LIKE '%$pesquisar%'";
	}
